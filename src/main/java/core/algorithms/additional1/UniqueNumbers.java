/*
Zad dodatkowe 1.Mamy dużo liczb od 1 do 10. Zliczamy ile jest niepowtarzających liczb (zlożoność liniowa)
...
class UniqueNumbers {
    ...
    private static void calculate() {
        ...
        //na tej podstawie wyznacza unikalne liczby
        ...
        try (Scanner scanner = new Scanner(new File(FILE_PATH))) {
            ...
            for (int i = 0; i < amount.length; i++) {
                if (amount[i] == 1) unique++;
            }

            System.out.println("Wystąpienia liczb: " + Arrays.toString(amount));
            System.out.println("Ilość unikalnych liczb: " + unique);
